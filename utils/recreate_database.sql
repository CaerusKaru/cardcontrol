...
INSERT INTO cardcontrol_accesspoint VALUES(1, '56 Professors Row, Medford, MA, 02155', 'Metcalf Hall', 'Metcalf East', now(), now(), 1, 1);
INSERT INTO cardcontrol_accesspoint VALUES(2, '56 Professors Row, Medford, MA, 02155', 'Metcalf Hall', 'Metcalf West', now(), now(), 1, 1);
INSERT INTO cardcontrol_accesspoint VALUES(3, '161 College Ave, Medford, MA, 02155', 'Halligan Hall', 'Main Entrance', now(), now(), 1, 1);
INSERT INTO cardcontrol_accesspoint VALUES(4, '161 College Ave, Medford, MA, 02155', 'Halligan Hall', 'Halligan Extension Entrance', now(), now(), 1, 1);
INSERT INTO cardcontrol_accesspoint VALUES(5, '574 Boston Ave, Medford, MA, 02155', 'CLIC', 'Main Entrance', now(), now(), 1, 1);
INSERT INTO cardcontrol_accesspoint VALUES(6, '574 Boston Ave, Medford, MA, 02155', 'CLIC', 'Physics Department', now(), now(), 1, 1);
