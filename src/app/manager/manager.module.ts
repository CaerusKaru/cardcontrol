...
import {ManagerAreasComponent, ManagerAreasDialogComponent, ManagerAreasDialogAddComponent} from './manager-areas/manager-areas.component';
...
@NgModule({
  ...
  declarations: [
    ...
    ManagerUsersAccessComponent,
    ManagerAreasDialogComponent,
    ManagerAreasDialogAddComponent
  ],
  providers: [
    ManagerService
  ],
