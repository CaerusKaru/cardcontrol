...
class UserAccount(models.Model):
    ...
    access_points = models.ManyToManyField('AccessPoint', related_name='%(class)s_access_points')
    access_points_managed = models.ManyToManyField('AccessPoint', related_name='%(class)s_access_points_managed')
